...
list_node_t *rect_list_unlink_next(list_t *rects, list_node_t *parent_child);
void rect_list_del_next(list_t *rects, list_node_t *parent_child);
void rect_list_clear(list_t *rects);
void rect_list_add_split_strict(list_t *rects, const rect_t r);
